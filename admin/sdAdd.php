...
?>	
 <form name="sdUpdate" method="post" action="updateSd.php?id=<?=$id?>&act=add">
...
<tr>
<td>day</td>
<td><input name="description" type="text" style="width:30px;"  value="<?=$day?>" ></td>
</tr>
<tr>
<td>month</td>
<td><input name="description" type="text" style="width:30px;"  value="<?=$month?>" ></td>
</tr>
<tr>
<td>isLunarDay</td>
